...
const VEHICLES = {
  uno: {
    ...
    name: 'Uno com Escada',
    tag: 'O LENDÁRIO',
    desc: 'O mito brasileiro. Rápido, leve.',
    ...
    brake: 0.35,
    handling: 3.6,
    mudTraction: 0.32, // Sofre na lama
    durability: 60,
    fuelEfficiency: 0.4,
    color: '#f5f6fa',
    accentColor: '#e74c3c',
  ...
  fusca: {
    id: 'fusca',
    name: 'Fusca Reformado',
    tag: 'O VALENTE DA TERRA',
    desc: 'Excelente tração em barro e alta tolerância a solavancos.',
  ...
  camionete: {
    ...
    name: 'Hilux Raiz',
    tag: 'FORÇA BRUTA 4X4',
    desc: 'Robusta, espaçosa e com caçamba reforçada.',
  ...
  jeep: {
    ...
    name: 'Jeep 4x4',
    tag: 'O REI DA LAMA',
    desc: 'O veterano indomável da Amazônia.',
  ...
  caminhao: {
    ...
    desc: 'O lendário Mercedes-Benz que abriu a Transamazônica.',
